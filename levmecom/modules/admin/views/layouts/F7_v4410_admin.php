...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="<?=$this->blocks['mobileIcon']?>" />
...
<div id="f7app">
    ...
    <div class="view view-main">
        <div data-name="<?=$this->blocks['pageName']?>" class="page pgname_<?=$this->blocks['pageName']?>">
            ...
            <?php if (isset($this->blocks['toolbar'])) :?>
                <?=$this->blocks['toolbar']?>
            <?php else :?>
                <?=$this->render('default_toolbar')?>
            <?php endif;?>
