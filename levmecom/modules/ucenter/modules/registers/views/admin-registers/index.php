...
$this->blocks['pageSize'] = levHelpers::pageSize(20);
        ...
        <div class="card-content">
            <table>
                ...
                <tr>
                    ...
                    <th class="input-cell numeric-cell wd60">
                        <a class="table-head-label sortable-cell numeric-cell <?=$sortfield=='typeid'?'sortable-cell-active sortable-'.$sort:''?>" href="<?=Url::current(['sort'=>$asort, 'sortfield'=>'typeid'])?>">分类ID</a>
                        <div class="input"><input type="text" class="srh" name="srh[typeid]" value="<?=isset($srh['typeid'])?$srh['typeid']:''?>" placeholder="搜索"></div>
                    </th>
                    <th class="input-cell label-cell">
                        <a class="table-head-label sortable-cell <?=$sortfield=='name'?'sortable-cell-active sortable-'.$sort:''?>" href="<?=Url::current(['sort'=>$asort, 'sortfield'=>'name'])?>">分类名称</a>
                    ...
                    <th class="input-cell numeric-cell wd60">
                        <a class="table-head-label sortable-cell numeric-cell <?=$sortfield=='uid'?'sortable-cell-active sortable-'.$sort:''?>" href="<?=Url::current(['sort'=>$asort, 'sortfield'=>'uid'])?>">UID</a>
                        <div class="input"><input type="text" class="srh" name="srh[uid]" value="<?=isset($srh['uid'])?$srh['uid']:''?>" placeholder="搜索"></div>
                    </th>
                    <th class="input-cell label-cell">
                        <a class="table-head-label sortable-cell <?=$sortfield=='password'?'sortable-cell-active sortable-'.$sort:''?>" href="<?=Url::current(['sort'=>$asort, 'sortfield'=>'password'])?>">密码</a>
                        <div class="input"><input type="text" class="srh" name="srh[password]" value="<?=isset($srh['password'])?$srh['password']:''?>" placeholder="搜索"></div>
                    </th>
                ...
                <?php foreach ($lists as $k => $v) : ?>
                    <tr>
                        ...
                        <td class="label-cell"><?=$v['password']?></td>
                        <td class="tab-center">
